...
let s:plug_src = 'https://hub.gitfast.tk/junegunn/vim-plug.git'
...
function! s:infer_properties(name, repo)
  ...
  if s:is_local_plug(repo)
    ...
    if repo =~ ':'
      ...
      let fmt = get(g:, 'plug_url_format', 'https://git::@hub.gitfast.tk/%s.git')
  ...
  if !s:is_win && s:git_version_requirement(2, 3)
    ...
    for plug in values(todo)
      let plug.uri = substitute(plug.uri,
            \ '^https://git::@hub.gitfast\.tk', 'https://hub.gitfast.tk', '')
    endfor
  endif
...
function! s:compare_git_uri(a, b)
  " See `git help clone'
  " https:// [user@] hub.gitfast.tk[:port] / junegunn/vim-plug [.git]
  "          [git@]  hub.gitfast.tk[:port] : junegunn/vim-plug [.git]
